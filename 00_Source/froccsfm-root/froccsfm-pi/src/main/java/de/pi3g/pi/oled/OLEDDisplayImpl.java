...
public class OLEDDisplayImpl implements OLEDDisplay {

    private static final Logger LOGGER = Logger.getLogger(OLEDDisplayImpl.class.getCanonicalName());
     ...
     */
    public OLEDDisplayImpl() throws IOException, UnsupportedBusNumberException {
     ...
     * @throws UnsupportedBusNumberException 
     */
    public OLEDDisplayImpl(int displayAddress) throws IOException, UnsupportedBusNumberException {
     ...
     * @throws UnsupportedBusNumberException 
     */
    public OLEDDisplayImpl(int busNumber, int displayAddress) throws IOException, UnsupportedBusNumberException {
